  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900 antialiased">
      <header className="sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-b border-neutral-100">
        <div className="px-4 sm:px-6 lg:px-12 xl:px-16 py-3 flex items-center justify-between">
      ...
      <section id="top" className="relative overflow-hidden">
        ...
        <div className="relative px-4 sm:px-6 lg:px-12 xl:px-16 py-24 sm:py-32">
      ...
      <section id="what" className="relative border-t border-neutral-100 bg-white">
        <div className="relative px-4 sm:px-6 lg:px-12 xl:px-16 py-20">
      ...
      <section id="proof" className="border-t border-neutral-100 bg-neutral-50">
        <div className="px-4 sm:px-6 lg:px-12 xl:px-16 py-20">
      ...
      <footer className="border-t border-neutral-100 bg-white">
        <div className="px-4 sm:px-6 lg:px-12 xl:px-16 py-16 flex flex-col sm:flex-row items-center justify-between gap-6 text-sm text-neutral-500">
